...
#define TOPICO_SUBSCRIBE "RamonEnviaCoisasAvulsas"     //tópico MQTT de escuta
#define TOPICO_PUBLISH   "RamonRecebeCoisasAvulsas"    //tópico MQTT de envio de informações para Broker
